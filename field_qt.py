...
class QtLabelField(QtField, LabelField, qt.QLabel):
  def __init__(self, gui, master, o, attr, undo_stack):
    qt.QLabel.__init__(self, "", master)
    super(QtLabelField, self).__init__(gui, master, o, attr, undo_stack)
...
class Qt_WithButtonField(QtField, _WithButtonField, qt.QHBox):
  def __init__(self, gui, master, o, attr, undo_stack, Field, button_text, on_button):
    qt.QHBox.__init__(self, master)
    super(Qt_WithButtonField, self).__init__(gui, master, o, attr, undo_stack, Field, button_text, on_button)
    button = qt.QPushButton(editobj2.TRANSLATOR(button_text), self)
